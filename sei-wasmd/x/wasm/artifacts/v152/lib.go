...
func (vm *VM) RemoveCode(checksum wasmvm.Checksum) error { _ = "STUB: not implemented"; return nil }
...
// Pin is idempotent.
func (vm *VM) Pin(checksum wasmvm.Checksum) error { _ = "STUB: not implemented"; return nil }
...
// Unpin is idempotent.
func (vm *VM) Unpin(checksum wasmvm.Checksum) error { _ = "STUB: not implemented"; return nil }
