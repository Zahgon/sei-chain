...
func errorID(codespace string, code uint32) string { _ = "STUB: not implemented"; return "" }

func getUsed(codespace string, code uint32) *Error { _ = "STUB: not implemented"; return nil }

func setUsed(err *Error) { _ = "STUB: not implemented"; return }
...
func New(codespace string, code uint32, desc string) *Error { _ = "STUB: not implemented"; return nil }

func (e Error) Error() string { _ = "STUB: not implemented"; return "" }

func (e Error) ABCICode() uint32 { _ = "STUB: not implemented"; return 0 }
...
func (e *Error) Wrap(desc string) error { _ = "STUB: not implemented"; return nil }
...
func Wrap(err error, description string) error { _ = "STUB: not implemented"; return nil }
...
func (e *wrappedError) Is(target error) bool { _ = "STUB: not implemented"; return false }
...
func Recover(err *error) { _ = "STUB: not implemented"; return }

// WithType is a helper to augment an error with a corresponding type message
func WithType(err error, obj interface{}) error { _ = "STUB: not implemented"; return nil }
...
func IsOf(received error, targets ...error) bool { _ = "STUB: not implemented"; return false }
