...
func (a pAddr) pNodeID() pNodeID { _ = "STUB: not implemented"; return *new(pNodeID) }
...
func (t *pexTable) ClearSearched() { _ = "STUB: not implemented"; return }

func (t *pexTable) All() iter.Seq[*pexEntry] { _ = "STUB: not implemented"; return nil }
...
func newPoolManager(cfg *poolConfig) *poolManager { _ = "STUB: not implemented"; return nil }
...
func (p *poolManager) toUpgrade() utils.Option[pNodeID] { _ = "STUB: not implemented"; return nil }
...
func (p *poolManager) PushUpgradePermit() { _ = "STUB: not implemented"; return }
...
func (p *poolManager) ClearPex(sender types.NodeID) { _ = "STUB: not implemented"; return }

func (p *poolManager) DialFailed(id types.NodeID) error { _ = "STUB: not implemented"; return nil }
...
func (p *poolManager) Disconnect(id connID) error { _ = "STUB: not implemented"; return nil }
