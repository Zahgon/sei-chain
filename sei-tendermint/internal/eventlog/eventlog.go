...
func New(opts LogSettings) (*Log, error) { _ = "STUB: not implemented"; return nil, nil }
...
func (lg *Log) Add(etype string, data types.EventData) error { _ = "STUB: not implemented"; return nil }
...
func (st logState) info() Info { _ = "STUB: not implemented"; return *new(Info) }
...
func (lg *Log) state() logState { _ = "STUB: not implemented"; return *new(logState) }
...
func (lg *Log) updateHead(newHead *logEntry) { _ = "STUB: not implemented"; return }
