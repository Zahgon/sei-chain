...
func New(opts Options) (*Queue, error) { _ = "STUB: not implemented"; return nil, nil }
...
func (q *Queue) Add(item interface{}) error { _ = "STUB: not implemented"; return nil }
...
// returns nil, false.
func (q *Queue) Remove() (interface{}, bool) { _ = "STUB: not implemented"; return nil, false }
...
func (q *Queue) popFront() interface{} { _ = "STUB: not implemented"; return nil }
