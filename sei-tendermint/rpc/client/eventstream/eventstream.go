...
func (s *Stream) fetchPages(ctx context.Context) ([]*coretypes.EventItem, error) {
	_ = "STUB: not implemented"
	return nil,
		// if non-empty, page through items before this
		nil
}
...
func (o *StreamOptions) batchSize() int { _ = "STUB: not implemented"; return 0 }

func (o *StreamOptions) resumeFrom() string { _ = "STUB: not implemented"; return "" }
...
func (e *MissedItemsError) Error() string { _ = "STUB: not implemented"; return "" }
